...
import com.example.jetpack_demo_test.domain.model.Species
import com.example.jetpack_demo_test.domain.model.Statistic
import javax.inject.Inject

class PetsDataSourceImpl
    @Inject
    constructor() : PetsDataSource {
        override suspend fun getData() = PetDetails(speciesList = prepareDataForPetBreeds(),)
